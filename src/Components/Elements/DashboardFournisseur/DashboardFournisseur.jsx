...
export default function DashboardFournisseur(){
    ...
    return(
        ...
        <button className={classes.boutonAjoutSousCategorie}  onClick={toggleFournisseurForm}>Ajouter un nouveau founisseur</button>
        <p className={classes.pOu}>Ou</p>
        <p className={classes.pPropositionList}>Selectionnez un founisseur déja existant</p>
        <div className={classes.cardsDashboardSousCategorie}>   
            <div className={classes.cardDashboardSousCategorie}>
                <div className={classes.imageCardDashboardSousCategorie}>
                    <p>Nom Fournisseur :<label> Jerry Entreprise</label></p>
                    <p>Pays d'origine :<label> France</label></p>
                </div>
