  ...
  return (
    <>
      <div className={classes.navBar}>
        ...
        <button
          className={
            (buttonClicked === "compte" && activeButton === true) ||
            activeButton === false
              ? classes.boutonNav1Style
              : classes.invisible
          }
        ...
        <button
          className={
            (buttonClicked === "panier" && activeButton === true) ||
            activeButton === false
              ? classes.boutonNav1Style
              : classes.invisible
          }
        ...
        <button
          className={
            (buttonClicked === "paramètre" && activeButton === true) ||
            activeButton === false
              ? classes.boutonNav1Style
              : classes.invisible
          }
        ...
        >
          <input
            type="text"
            name=""
            placeholder="recherche par sous categorie"
          />
          <button type="submit">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div
          className={
            buttonClicked === "les catégories" && activeButton === true
              ? classes.boutonNav1Style
              : classes.invisible
          }
        >
        ...
        {sousCategories.map((sousCategorie) => {
          return (
            <div
              ...
              className={classes.sousNavBarCategorieDiv}
            >
              <Link
                to={`/categoryProduct/${sousCategorie.id}`}
                className={classes.boutonNavBarCategorie}
              >
