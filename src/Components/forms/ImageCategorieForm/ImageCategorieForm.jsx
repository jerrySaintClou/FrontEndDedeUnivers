import classes from "./ImageCategorieForm.module.css";
import { z } from "zod";
    ...
    return(
        ...
        >
		    <div className={classes.inputDivStyle}>
			    <label for="nomCategorie">Ajouter une image à la categorie</label>
			    <input 
				    type="text" 
		    ...
		    <button className={classes.buttonStyleContact}>Ajouter une image à la categorie</button>
        </form>
    )
}